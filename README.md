...
Η μέγιστη διαφορά θέσης είναι 3 θέσσεις για παίκτες που είναι από τις θέσεις 1 έως 9. Για παίκτες που είναι μεγαλύτερη
...
### Η λειτουργία προσθήκης παίκτη είναι διαθέσιμη με εισαγωγή είτε σε συγκεκριμένη θέση είτε στο τέλος της κατάταξης. Η λειτουργία διαγραφής παίκτη γίνεται βάσει θέσσης και υπάρχει επιβεβαίωση διαγραφής. Σε αυτό το παράθυρο διαλόγου παρουσιάζεται το όνομα του εν λόγω παίκτη για αποφυγή λαθών.
